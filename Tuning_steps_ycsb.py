...
def stdout_to_dict(stdout_recorder):
    temp_dict = {}
    temp_dict["throughput"] = stdout_recorder.benchmark_results["ycsb_load"][1].split(" ")[0]
...
if __name__ == '__main__':
    ...
    ycsb_workload_dir = "LOG_DIR/PM_results_ycsb_FEAT_v6/"

    dirs = get_log_dirs(ycsb_workload_dir)
