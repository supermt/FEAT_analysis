...
def plot_with_thread_num(thread_num, batch_size, start_time, end_time):
    ...
    plt.savefig("paper_usage/%d_threads_mapping_%d_to_%d.pdf" % (thread_num, start_time, end_time))
    plt.savefig("paper_usage/%d_threads_mapping_%d_to_%d.png" % (thread_num, start_time, end_time))
