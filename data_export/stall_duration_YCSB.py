...
if __name__ == '__main__':
    ...
    target_map = {
        # "FEAT_YCSBload30GB+zipfian_1000": extract_stall_and_duration("../LOG_DIR/PM_results_ycsb_FEAT_v6/a/"),
        # "FEAT_YCSBload30GB+latest_1000": extract_stall_and_duration("../LOG_DIR/PM_results_ycsb_FEAT_v6/d/"),
        # "FEAT_YCSBload30GB+uniform_1000": extract_stall_and_duration("../LOG_DIR/PM_results_ycsb_FEAT_v6/e/"),
        #
        # "default_YCSBload30GB+zipfian_1000": extract_stall_and_duration("../LOG_DIR/PM_results_ycsb_baseline_large/a/"),
        # "default_YCSBload30GB+latest_1000": extract_stall_and_duration("../LOG_DIR/PM_results_ycsb_baseline_large/d/"),
        # "default_YCSBload30GB+uniform_1000": extract_stall_and_duration("../LOG_DIR/PM_results_ycsb_baseline_large/e/"),
        "default_YCSBload60GB+zipfian_1000": extract_stall_and_duration(
            "../LOG_DIR/PM_results_ycsb_load_60GB/baseline/a/"),
        "default_YCSBload60GB+latest_1000": extract_stall_and_duration(
            "../LOG_DIR/PM_results_ycsb_load_60GB/baseline/d/"),
        "default_YCSBload60GB+uniform_1000": extract_stall_and_duration(
            "../LOG_DIR/PM_results_ycsb_load_60GB/baseline/e/"),

        "FEAT_YCSBload60GB+zipfian_1000": extract_stall_and_duration("../LOG_DIR/PM_results_ycsb_load_60GB/FEAT/a/"),
        "FEAT_YCSBload60GB+latest_1000": extract_stall_and_duration("../LOG_DIR/PM_results_ycsb_load_60GB/FEAT/d/"),
        "FEAT_YCSBload60GB+uniform_1000": extract_stall_and_duration("../LOG_DIR/PM_results_ycsb_load_60GB/FEAT/e/"),
    }
    result_list = []
    ...
    result_df.to_csv("csv_results/stall_duration_ycsb.csv", index=False, sep=" ")
