...
if __name__ == '__main__':
    ...
    stall_type_distribution_pd.to_csv("paper_usage/knob_choosing/batch_stall_changing.csv")
    stall_type_distribution_pd.to_csv("paper_usage/knob_choosing/batch_stall_changing.csv")
    ...
    fig = px.bar(stall_type_distribution_pd, x="thread number", facet_row="device", facet_col="stall type",
                 y="stall amount", barmode="group",
                 color="batch size", category_orders={
            "device": devices, "batch size": ["64MB", "128MB"], "thread number": ["1 ", "4 ", "20 "]
    ...
    fig.write_image("paper_usage/knob_choosing/batch/batch_influence_stall_changing.png")
