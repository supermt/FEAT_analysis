...
if __name__ == '__main__':
    ...
    log_dir_prefix = "LOG_DIR/pm_result_cpu_or_thread/12cpu"
    ...
    # plt.tight_layout()
    plt.savefig("paper_usage/6cpu/cpu_utils_in_one_page_all.pdf")
    plt.savefig("paper_usage/6cpu/cpu_utils_in_one_page_all.png")
